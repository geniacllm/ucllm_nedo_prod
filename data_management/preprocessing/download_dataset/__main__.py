...
def parse_args():
    ...
    parser.add_argument(
        "--split", type=str, default="", help="Dataset split to download"
    )
    parser.add_argument(
        "--output_base",
        type=str,
    ...
    parser.add_argument(
        "--index_from", type=int, default=0, help="Index to start downloading"
    )
    parser.add_argument(
        "--index_to", type=int, default=0, help="Index to stop downloading"
    )
